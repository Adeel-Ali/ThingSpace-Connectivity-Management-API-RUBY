...
module ThingSpaceConnectivityManagementApi
  class LeadsController < BaseController
    ...
    # @param [Long] mnext Optional parameter: Continue the previous query from the pageUrl in Location Header
    # @return LeadInformationResponse response from the API call
    def get_list_using_get_1(vz_m_2_m_token, 
      ...
      return LeadInformationResponse.from_hash(decoded)
    end
  end
end
