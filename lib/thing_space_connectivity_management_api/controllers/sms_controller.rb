...
module ThingSpaceConnectivityManagementApi
  class SmsController < BaseController
    ...
    # @param [String] aname Required parameter: Account name
    # @param [String] vz_m_2_m_token Required parameter: M2M-MC Session Token
    # @param [Long] mnext Optional parameter: Continue the previous query from the URL in Location Header
    ...
    def get_sms_messages_using_get(aname, 
      ...
      # Return appropriate response type
      decoded = APIHelper.json_deserialize(_response.raw_body)
      return SmsMessagesResponse.from_hash(decoded)
    end

    # Sends an SMS message to one or more devices.
    # @param [SMSSendRequest] request Required parameter: SMS Request
    # @param [String] vz_m_2_m_token Required parameter: M2M-MC Session Token
